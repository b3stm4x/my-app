...
@Route(value = "fleetmanagement/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class FleetmanagementView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "fleetmanagement/%s/edit";
    ...
    public FleetmanagementView(SamplePersonService samplePersonService) {
